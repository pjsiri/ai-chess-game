...
public class Rook extends Piece {
    ...
    public Rook(PieceColour colour, int position, boolean isMoved,Board board)
    {
        super(colour, 500, position, isMoved);
        this.board = board;
        availableMoves = new HashSet<>();
        targetingSquares = new HashSet<>();
    }
    
    public Rook(Piece piece, Board board)
    {
        super(piece.getColour(), 500, piece.getPosition(), piece.isMoved());
        this.board = board;
        availableMoves = new HashSet<>();
        targetingSquares = new HashSet<>();
    }
