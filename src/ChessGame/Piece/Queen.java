...
public class Queen extends Piece {
    ...
    public Queen(PieceColour colour,int col, int row, PiecesOnBoard board)
    {
        super(colour, col, row, 9);
        this.board = board;
    }
    
    public Queen(PieceColour colour, int col, int row, int LMN, boolean HNM, boolean HMO, PiecesOnBoard board)
    {
        super(colour, col, row, LMN, HNM, HMO, 9);
        this.board = board;
    }
